...
const Sider = () => {
  ...
  return (
    <ul className="menu  menu-lg bg-base-200 rounded-box w-80 h-[calc(100vh-35px)]">
      <li>
        <a className="font-bold" onClick={() => handleNavigation("/")}>
          <svg
      ...
      <li>
        <a className="font-bold" onClick={() => handleNavigation("/myevent")}>
          <svg
            className="h-5 w-5 "
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <a className="font-bold" onClick={() => handleNavigation("/addevent")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
